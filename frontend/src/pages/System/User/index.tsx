import CrudComponent from '@/components/CrudComponent/index';
import type { FormConfig } from '@/components/DynamicForm/index';
import type {
  PaginationParams,
  TableConfig,
} from '@/components/DynamicTable/index';
...
const UserManagement: React.FC = () =>
{
  ...
  const api = {
    list: async ( params: PaginationParams ) =>
    {
      ...
      } catch ( error: unknown )
      {
        ...
        return {
          success: false,
          message: apiError.message || '获取用户列表失败',
        };
      }
    },
    create: async ( data: Partial<User> ) =>
    {
      ...
      } catch ( error: unknown )
      {
        ...
        return {
          success: false,
          message: apiError.message || '用户创建失败',
        };
      }
    },
    update: async ( id: string, data: Partial<User> ) =>
    {
      ...
      } catch ( error: unknown )
      {
        ...
        return {
          success: false,
          message: apiError.message || '用户更新失败',
        };
      }
    },
    delete: async ( id: string ) =>
    {
      ...
      } catch ( error: unknown )
      {
        ...
        return {
          success: false,
          message: apiError.message || '用户删除失败',
        };
      }
    },
  ...
  const handleCustomAction = ( action: string, record: User ) =>
  {
  ...
  const handleExport = async () =>
  {
    ...
    {
      const apiError = error as Error;
      message.error( apiError.message || '用户导出失败' );
    }
  };
