...
// plugins
export { Access, useAccess, useAccessMarkedRoutes } from 'E:/YSY/UG/frontend/src/.umi-production/plugin-access';
export { Provider, useModel } from 'E:/YSY/UG/frontend/src/.umi-production/plugin-model';
export { useRequest, UseRequestProvider, request, getRequestInstance } from 'E:/YSY/UG/frontend/src/.umi-production/plugin-request';
// plugins types.d.ts
...
export { ApplyPluginsType, PluginManager } from 'E:/YSY/UG/node_modules/.pnpm/umi@4.4.12_@babel+core@7.28.4_@types+node@20.19.13_@types+react@18.3.24_eslint@8.35.0_jest@29_cpoj4sm7sqlrpfbtsbqfspsuqi/node_modules/umi/client/client/plugin.js';
